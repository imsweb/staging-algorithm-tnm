...
[![Build Status](https://travis-ci.org/imsweb/staging-algorithm-tnm.svg?branch=master)](https://travis-ci.org/imsweb/staging-algorithm-tnm)
...
```groovy
compile 'com.imsweb.com:staging-algorithm-tnm:1.8'
```
